...
STRIPE_NONSTUDENT_PRICE_ID = os.getenv("STRIPE_NONSTUDENT_PRICE_ID")
...
def generate_exam():
    ...
    exam_prompt = (
        ...
        "and relevant findings for head, neck, chest, abdomen, and extremities. Keep the response succinct and use minimal tokens while ensuring no section is omitted."
    )
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4-turbo",
